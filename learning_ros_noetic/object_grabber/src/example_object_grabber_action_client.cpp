...
void set_example_object_frames(geometry_msgs::PoseStamped &object_poseStamped,
    ...
    object_dropoff_poseStamped.pose.position.x = 0.6;
    object_dropoff_poseStamped.pose.position.y = -0.3;
    object_dropoff_poseStamped.pose.position.z = 0.87;
    // object_dropoff_poseStamped.pose.orientation.z = 0;
